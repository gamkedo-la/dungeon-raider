export const ArmorChainMailType = 'lootChainMail'
export const ArmorHalfPlateMailType = 'lootHalfPlateMail'
export const ArmorHelmetType = 'lootHelmet'
export const ArmorLeatherArmorType = 'lootLeatherArmor'
export const ArmorPlateMailType = 'lootPlateMail'
...
export const LootFoodLargeType = 'lootFoodLarge'
export const LootFoodSmallType = 'lootFoodSmall'
